...
#ifndef DMA_STM32_FAKE_H_
#define DMA_STM32_FAKE_H_
...
class DMA_Stream_TypeDef : public Fake::Peripheral
{
public:
    // Methods for unit testing
    void registers_to_default(void) override;

    // Fake registers of DMA stream
    Fake::Register_t CR;   /*!< DMA stream x configuration register      */
    Fake::Register_t NDTR; /*!< DMA stream x number of data register     */
    Fake::Register_t PAR;  /*!< DMA stream x peripheral address register */
    Fake::Register_t M0AR; /*!< DMA stream x memory 0 address register   */
    Fake::Register_t M1AR; /*!< DMA stream x memory 1 address register   */
    Fake::Register_t FCR;  /*!< DMA stream x FIFO control register       */
};

class DMA_TypeDef : public Fake::Peripheral
{
public:
    // Methods for unit testing
    void registers_to_default(void) override;

    // Fake registers of DMA
    Fake::Register_t LISR;  /*!< DMA low interrupt status register,      Address offset: 0x00 */
    Fake::Register_t HISR;  /*!< DMA high interrupt status register,     Address offset: 0x04 */
    Fake::Register_t LIFCR; /*!< DMA low interrupt flag clear register,  Address offset: 0x08 */
    Fake::Register_t HIFCR; /*!< DMA high interrupt flag clear register, Address offset: 0x0C */
};
...
// Fake addresses
extern std::uintptr_t DMA1_BASE;
extern std::uintptr_t DMA1_Stream0_BASE;
extern std::uintptr_t DMA1_Stream1_BASE;
extern std::uintptr_t DMA1_Stream2_BASE;
extern std::uintptr_t DMA1_Stream3_BASE;
extern std::uintptr_t DMA1_Stream4_BASE;
extern std::uintptr_t DMA1_Stream5_BASE;
extern std::uintptr_t DMA1_Stream6_BASE;
extern std::uintptr_t DMA1_Stream7_BASE;
extern std::uintptr_t DMA2_BASE;
extern std::uintptr_t DMA2_Stream0_BASE;
extern std::uintptr_t DMA2_Stream1_BASE;
extern std::uintptr_t DMA2_Stream2_BASE;
extern std::uintptr_t DMA2_Stream3_BASE;
extern std::uintptr_t DMA2_Stream4_BASE;
extern std::uintptr_t DMA2_Stream5_BASE;
extern std::uintptr_t DMA2_Stream6_BASE;
extern std::uintptr_t DMA2_Stream7_BASE;
