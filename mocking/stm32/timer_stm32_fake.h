...
#ifndef TIMER_STM32_FAKE_H_
#define TIMER_STM32_FAKE_H_
...
class TIM_TypeDef: public Fake::Peripheral
{
public:
  ...
  Fake::Register_t CR1;         /*!< TIM control register 1,              Address offset: 0x00 */
  Fake::Register_t CR2;         /*!< TIM control register 2,              Address offset: 0x04 */
  Fake::Register_t SMCR;        /*!< TIM slave mode control register,     Address offset: 0x08 */
  Fake::Register_t DIER;        /*!< TIM DMA/interrupt enable register,   Address offset: 0x0C */
  Fake::Register_t SR;          /*!< TIM status register,                 Address offset: 0x10 */
  Fake::Register_t EGR;         /*!< TIM event generation register,       Address offset: 0x14 */
  Fake::Register_t CCMR1;       /*!< TIM capture/compare mode register 1, Address offset: 0x18 */
  Fake::Register_t CCMR2;       /*!< TIM capture/compare mode register 2, Address offset: 0x1C */
  Fake::Register_t CCER;        /*!< TIM capture/compare enable register, Address offset: 0x20 */
  Fake::Register_t CNT;         /*!< TIM counter register,                Address offset: 0x24 */
  Fake::Register_t PSC;         /*!< TIM prescaler,                       Address offset: 0x28 */
  Fake::Register_t ARR;         /*!< TIM auto-reload register,            Address offset: 0x2C */
  Fake::Register_t RCR;         /*!< TIM repetition counter register,     Address offset: 0x30 */
  Fake::Register_t CCR1;        /*!< TIM capture/compare register 1,      Address offset: 0x34 */
  Fake::Register_t CCR2;        /*!< TIM capture/compare register 2,      Address offset: 0x38 */
  Fake::Register_t CCR3;        /*!< TIM capture/compare register 3,      Address offset: 0x3C */
  Fake::Register_t CCR4;        /*!< TIM capture/compare register 4,      Address offset: 0x40 */
  Fake::Register_t BDTR;        /*!< TIM break and dead-time register,    Address offset: 0x44 */
  Fake::Register_t DCR;         /*!< TIM DMA control register,            Address offset: 0x48 */
  Fake::Register_t DMAR;        /*!< TIM DMA address for full transfer,   Address offset: 0x4C */
  Fake::Register_t OR;          /*!< TIM option register,                 Address offset: 0x50 */
};
