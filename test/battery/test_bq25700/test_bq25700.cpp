...
namespace bus {
    ...
    {
        ::read_word(reg);
        uint8_t pos = bus.buffer_position++;
...
void test_register_ChargeOption0()
{
    ...
    TEST_ASSERT_EQUAL(bq25700::registers::Charge_Option_0, reg.address);
...
void test_init()
{
    ...
    TEST_ASSERT_EQUAL(0, static_cast<uint8_t>(UUT.get_state()));
};
...
void test_set_options()
{
    ...
    TEST_ASSERT_TRUE(UUT.write_register(bq25700::registers::Charge_Option_0, 0x1234));
    ...
    TEST_ASSERT_EQUAL(3, static_cast<uint8_t>(UUT.get_state()));
    ...
    TEST_ASSERT_EQUAL(1, static_cast<uint8_t>(UUT.get_state()));
