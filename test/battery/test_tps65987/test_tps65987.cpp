...
namespace Bus
{
    ...
    bool send_array(I2C_Mock bus, const std::uint8_t *data, const std::uint8_t n_bytes)
    {
...
void test_class_status()
{
    ...
    TEST_ASSERT_EQUAL(TPS65987::Register::Status.length, data.size());

    // Test reading the register options
    TEST_ASSERT_EQUAL(TPS65987::Register::Status.address, status.address);
    TEST_ASSERT_EQUAL(TPS65987::Register::Status.length, status.length);
...
void test_class_global_system_configuration()
{
    ...
    TEST_ASSERT_EQUAL(TPS65987::Register::Global_SysConfig.length, data.size());

    // Test reading the register options
    TEST_ASSERT_EQUAL(TPS65987::Register::Global_SysConfig.address, global_config.address);
    TEST_ASSERT_EQUAL(TPS65987::Register::Global_SysConfig.length, global_config.length);
...
void test_class_port_configuration()
{
    ...
    TEST_ASSERT_EQUAL(TPS65987::Register::Port_Config.length, data.size());

    // Test reading the register options
    TEST_ASSERT_EQUAL(TPS65987::Register::Port_Config.address, port_config.address);
    TEST_ASSERT_EQUAL(TPS65987::Register::Port_Config.length, port_config.length);
...
void test_class_port_control()
{
    ...
    TEST_ASSERT_EQUAL(TPS65987::Register::Port_Ctrl.length, port_control.length);
