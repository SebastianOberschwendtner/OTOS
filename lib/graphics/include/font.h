...
namespace Font {
     ...
     */
    constexpr unsigned char x_pixels(const Size fontsize)
    {
        switch(fontsize)
        {
            case Size::Small: return 6;
            case Size::Normal: return 12;
        }
        return 0;
    };
    constexpr unsigned char y_pixels(const Size fontsize)
    {
        switch(fontsize)
        {
            case Size::Small: return 8;
            case Size::Normal: return 16;
        }
        return 0;
    };
